...
<html> 
 ...
 <body> <a id="HOME" "></a> 
  ...
  <br> 
  <h2>Tour Benefits:</h2> 
  <br> 1. Cultural immersion 
  <br> 2. Personal growth 
  <br> 3. Relaxation and stress relief 
  <br> 4. New experiences and skills 
  <br> 5. Meeting new people 
  <br> 6. Learning about history and culture 
  <br> 7. Enjoying new foods and drinks 
  <br> 8. Creating lifelong memories 
  <br> Would you like to know more about a specific type of tour or destination? 
  <p></p> 
  <br> <button>click here</button> 
  <div style="background-color: #C6F4D6;"> 
   <br> 
   <br> 
   <br> <a id="LOGIN"></a> 
   <h1>DETAILS</h1> 
   ...
   <br> 
   <input type="password "> 
   <br> <button>Login in</button> 
   <input type="Reset"> 
   <br> 
   <p>Sign in new user</p> <button>Sign in</button> 
   <br> 
   <img src="https://www.treebo.com/blog/wp-content/uploads/2018/06/manali.jpg"> 
   <br> 
   <img src="https://environics.ca/wp-content/uploads/2024/03/Newcomers-Feature.png" width="800" height="600"> 
   <br> 
   <br> 
   <br> 
   <br> 
  ...
  <div style="background-color:#FFB6C1;"> 
   ...
   <h2>MOUNTAIN</h2> 
   <br> 
   <img src="https://hips.hearstapps.com/hmg-prod/images/alpe-di-siusi-sunrise-with-sassolungo-or-langkofel-royalty-free-image-1623254127.jpg" width="200" height="200"> 
